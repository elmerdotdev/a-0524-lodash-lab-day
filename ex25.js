...
// 25. Create an array of objects where each object contains the state and the total population of Democrat cities in that state.

const democratStatePopulations = 

console.log(democratStatePopulations);
// Expected output: [
//   { state: 'New York', population: 8336817 },
//   { state: 'California', population: 7313107 },
//   { state: 'Illinois', population: 2693976 },
//   { state: 'Pennsylvania', population: 1584138 },
//   { state: 'Washington', population: 744955 },
//   { state: 'D.C.', population: 712816 }
// ]