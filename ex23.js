...
// 23. List all cities in Texas and sort them by population in descending order.

const texasCities = 

console.log(texasCities); // Expected output: ["Houston", "San Antonio", "Dallas", "Austin", "Fort Worth"]